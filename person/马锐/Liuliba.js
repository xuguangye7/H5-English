          ...
          <View>
            <View style={{
                ...
                height:80,
                    ...
                    <View style={{
                        ...
                        >
                          <Image source={require('./img/fang.png')} style={{height:25,width:25}}/>
                          <Text style={{color:'#aaaaaa'}}>&nbsp;大家正在搜：今日话题</Text>
                        </TextInput>
                ...
                <Swiper 
                    ...
                    >
                    <Image source={require('./img/a.jpg')} style={{height: 450}}/>
                    <Image source={require('./img/b.jpg')} style={{height: 450}}/>
                    <Image source={require('./img/c.jpg')} style={{height: 450}}/>
                </Swiper>
                </View>
                {/* 中部四个按钮 */}
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <Text style={{color:'grey',fontSize:15,marginTop:10,marginLeft:190}}
                    >8888浏览&nbsp;&nbsp;888回复</Text>
                </View>          
            </View>
        </View>
