...
import { Text, View,Dimensions,DeviceEventEmitter,StyleSheet, ScrollView,Image,TouchableOpacity,TextInput,ToastAndroid, ImageBackground} from 'react-native'
...
export default class Learn extends Component {
    ...
    componentDidMount(){
        ...
        fetch('http://129.211.62.80:8080/word/writ')
        .then(res=>res.json())
        .then(res=>{
            console.log(res.content)
            this.setState({
                    ...
                    <View style={style}>
                        <ScrollView>
                            <View style={styles.card}>
                                <ImageBackground source={require('../../assets/1.png')}  style={{width:'100%', height:'100%',alignItems:'center'}}>
                                    <View style={{
                                        width:'100%',
                                        height:160,
                            ...
                            <View style={styles.oral}>
                                <View style={styles.course1}>
                                    <View style={{padding:5}}>
                                        <Text style={{fontSize:16}}>精品范文</Text>
                                    </View>
                                    <View  style={{padding:5}}>
                                        <Text >全部文章></Text>
                                    </View>
                            ...
                            {/* 测试用代码 */}
                            <TouchableOpacity style={{width:"100%",alignItems:'center'}} onPress={()=>{Actions.write()}}>
                                <Text style={{fontSize:24}}>课文</Text>
                            </TouchableOpacity>
