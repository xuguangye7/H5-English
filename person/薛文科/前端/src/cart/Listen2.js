...
export default class Main extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            btnModel:require('../../assets/course3.jpg'), //播放模式按钮背景图
            pic_small:'',    //小图
            pic_big:'',      //大图
            ...
            isplayBtn:require('../../assets/pause.png'),  //播放/暂停按钮背景图
    ...
    playModel = (playModel) =>{
        ...
        if(playModel == 1){
            this.setState({
                btnModel:require('../../assets/timg.jpg'),
            })
        }else if(playModel ==  2){
            this.setState({
                btnModel:require('../../assets/timg.jpg'),
    ...
    playAction =() => {
        ...
        if(this.state.pause == true){
            this.setState({
                isplayBtn:require('../../assets/pause.png')
            })
        }else {
            this.setState({
                isplayBtn:require('../../assets/bofang.png')
            })
        }
    ...
    //播放器每隔250ms调用一次
    onProgress =(data) => {
        let val = parseInt(data.currentTime)+0.0001
        this.setState({
            sliderValue: val-0.0001,
                    ...
                    <View style = {{position:'absolute',width: width,height:500}}>
                        ...
                        <View style = {{flexDirection:'row',justifyContent:'space-around'}}>
                            <TouchableOpacity onPress={()=>this.prevAction(this.state.currentIndex - 1)}>
                                <Image source={require('../../assets/shangyiqu101.png')} style={{width:40,height:40}}/>
                            </TouchableOpacity>
                            ...
                            <TouchableOpacity onPress={()=>this.nextAction(this.state.currentIndex + 1)}>
                                <Image source={require('../../assets/xiayiqu101.png')} style={{width:40,height:40}}/>
                            </TouchableOpacity>
                        </View>
                    </View>
